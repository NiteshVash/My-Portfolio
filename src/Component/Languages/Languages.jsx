...
function Languages() {
  const [showLangAbout, setShowLangAbout] = useState({ html: false, js: false, react: false, java: false  , Css : false , Cplus : false , Clang : false });

  return (
    <section id='Languagessection' className='Languagessection'>
      <div className="Languagescontainer">
        <h1 className='Languagesconatinerheading'>Languages</h1>
        <div className="languagesdiscription">I learn these languages from my institute and social media platforms.</div>
        <div className="languagecontainer2">
          ...
          <div className="languagename" onClick={() => setShowLangAbout({ html: false, js: true, react: false, java: false })}>
            <div className="languagenametitle">JavaScript</div>
          ...
          <div className="languagename" onClick={() => setShowLangAbout({ html: false, js: false, react: false, java: false })}>
      ...
      {showLangAbout.Css && <CssInfo onClose={() => setShowLangAbout({ html: false, js: false, react: false, java: false })} />}
      {showLangAbout.Cplus && <CPlusPlusInfo onClose={() => setShowLangAbout({ html: false, js: false, react: false, java: false })} />}
      {showLangAbout.Clang && <Cinfo onClose={() => setShowLangAbout({ html: false, js: false, react: false, java: false })} />}
    </section>
  )
}
